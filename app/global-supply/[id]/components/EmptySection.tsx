  ...
  return (
    <main className="min-h-screen bg-gray-50 pb-28">
      ...
      <div className="mx-auto mt-20 max-w-md px-4 text-center">
        ...
        <p className="mb-6 text-sm leading-relaxed text-gray-500">{t('detail.productNotFoundDesc', locale)}</p>
        <Link href="/global-supply" className="inline-flex items-center gap-2 rounded-lg bg-brand-400 px-6 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-brand-500">
